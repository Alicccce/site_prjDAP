...
const submitAnswers = async () => {
  ...
  try {
    await questionsApi.saveUserPreferences(answers.value)
    
    successMessage.value = 'Ответы сохранены! Составляем план...'
    ...
    errorMessage.value = error.response?.data?.message || 'Ошибка ввода'
  } finally {
    loading.value = false
  }
}
